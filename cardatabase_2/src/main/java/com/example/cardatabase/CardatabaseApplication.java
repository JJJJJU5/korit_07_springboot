...
public class CardatabaseApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// 그리고 Car의 생성자에 field를 추가했기 때문에 오류 나는 것을 막기 위해 owner들을 추가한다.
...
//		}
		...
		// AppUser 더미데이터를 추가
		// 저 위에 보시면 Owner의 경우에는 owner1 / onwer2 만들어가지고 ownerRepository에 저장했었다.
		userRepository.save(new AppUser("user","$2a$12$GidqgsnKBA3JU/pF/bQPMulSojc0pRRf1Llz4AYDufbGVU84EVrN6","USER"));
		userRepository.save(new AppUser("admin","$2a$12$vS6iFqnpBuC0P4C7R83ALeB211WhQs5pd4yxSFEMiE1k0DOuMD2My","ADMIN"));
